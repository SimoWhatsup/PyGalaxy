        ...
        if self.mosaic == 'skymap':
            ...
            if HI_all_OR:
                if self.survey == 'CGPS':
                    ...
                    # SGPS I
                    list1 = ['G258.0', 'G268.0', 'G278.0', 'G288.0', 'G298.0', 'G308.0', 'G318.0', 'G328.0', 'G338.0',
                             'G348.0']
                    # SGPS II
            ...
            if HI_all_OR:
                list = [f for f in os.listdir(path) if
                        f.startswith('%s_%s_%s_%s_part' % (self.survey, self.mosaic, flag1, flag2))]
                list = sort(list)
